...
// deps를 생략하면
// 컴포넌트가 Mount 될 때 한번 + 리렌더링(업데이트) 될 때마다 실행

// 만약 Mount 될 때를 제외하고 싶다면
// 현재 컴포넌트가 Mount가 되었는지 체크하는 변수 생성 (useRef 이용)
...
// 업데이트될 때마다 현재 업데이트된 state의 값을 검사하거나
