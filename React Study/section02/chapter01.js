...
let f5 = NaN;
let f6 = ""; // 빈문자열
let f7 = 0n; // BigInt로 아주 큰 값을 저장할 때 사용 (잘 사용하지 않음)
...
// 조건문으로 매개변수 값이 null 이거나 undefined이 아님을 먼저 확인해야 함

// Truthy, Falsy를 이용하지 않고 진행한다면
...
printName2(person); // person의 값이 undefined

// 복잡한 조건문을 반복적으로 적는 것은 비효율적
// Truthy, Falsy를 이용하여 개선
function printName3(person) {
  // person 값이 Falsy인 경우 (undefined, null)
